...
public class HttpClientUtils {
	...
	private static CloseableHttpClient getHttpClient() {
		...
		RequestConfig requestConfig = RequestConfig.custom()
				.setConnectTimeout(600000).setSocketTimeout(600000).build();//标准Cookie策略
		return HttpClients.custom().setConnectionManager(poolingConnectionMgr)
				.setDefaultRequestConfig(requestConfig)//设置cookie策略
				.build();
	}
